...
public class marcher : MonoBehaviour
{
    ...
    public float noiseDensity = 0.4f;
    ...
    public terrainType type = terrainType.Caves;

    public float floorScale = 90f;
    private float Xoffset;
    private float Zoffset;

    public float noiseLayers = 8;
    ...
    private void Start()
    {
        ...
        Xoffset = transform.position.x + 1000;
        Zoffset = transform.position.z + 1000;
